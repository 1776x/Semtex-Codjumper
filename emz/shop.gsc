main()
{
	level.modelcost[0]=750;
	level.modelcost[1]=1000;
	level.modelcost[2]=1500;
	level.modelcost[3]=2000;
	level.modelcost[4]=3000;
...
connect()
{
	...
	self setClientDvars("showpoints",1,
						"shop0","Captain Price - 750$",
						"shop1","Makarov - 1000$",
						"shop2","Shepherd - 1500$",
						"shop3","Duke Nukem - 2000$",
						"shop4","50 Cent - 3000$");
}
check()
{
